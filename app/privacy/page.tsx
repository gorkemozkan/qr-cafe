      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p className="mb-4 leading-relaxed text-muted-foreground">
            Only Menu ("we", "us", "our") respects your privacy and is committed to protecting your personal
            information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when
            you use our QR code menu management platform.
          </p>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <div className="border-t mt-8 pt-8">
            <p className="text-sm text-muted-foreground mt-2">
              This Privacy Policy is part of our Terms of Service. By using Only Menu, you acknowledge that you have
